...
async function main() {
    ...
    const yCRV = await ethers.getContractAt("IERC20Metadata", "0xFCc5c47bE19d06BF83eB04298b026F81069ff65b");
    const cvxCrvFrax = await ethers.getContractAt("IERC20Metadata", "0x527331f3f550f6f85acfecab9cc0889180c6f1d5");


    const supportedCoinList = [dai, usdc, usdt, frax, threeCrvLp, ust, crv, cvx, alluo, weth, reth, ldo, spell, angle, eurs, ageur, eurt, stEthEth, fraxUsdc, cvxEth, wbtc, fxs, fraxBP, yCRV, cvxCrvFrax];
