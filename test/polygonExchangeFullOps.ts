...
describe("Exchange (full setup operations)", async () => {
    ...
    const eurtPoolAddress = "0x9b3d675FDbe6a0935E8B7d1941bc6f78253549B7";
    ...
    before(async () => {
        ...
        eurt = await ethers.getContractAt("IERC20Metadata", "0x172370d5Cd63279eFa6d502DAB29171933a610AF");
    ...
    it("Should check all available swaps", async () => {
        const supportedCoinList = [dai, usdc, usdt, eurt, weth];
